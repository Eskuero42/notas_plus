...
<body class="hold-transition sidebar-mini">
    ...
    <style>
        ...
        .big-toast {
            font-size: 18px !important; /* Ajusté el tamaño del texto a un valor más moderado */
            padding: 15px !important;   /* Ajusta el padding para hacerlo más grande */
            border-radius: 10px;        /* Redondea las esquinas */
            background-color: #28a745 !important;  /* Color de fondo (verde, por ejemplo) */
            color: #fff !important; /* Color del texto */
        }
    
        /* Aumentar el tamaño del texto del mensaje */
        .big-toast .swal2-title {
            font-size: 20px !important;  /* Aseguramos un tamaño de texto más moderado */
